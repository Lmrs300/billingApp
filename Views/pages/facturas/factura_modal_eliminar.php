...
<script type="text/javascript">
    function showModalElim(e) {
        ...
        par.html(`¿Esta seguro que desea eliminar la factura con serial: <b>${serial_fac}</b>, de fecha: <b>${fec_fac}</b>?`)
...
<div class="modal-fade-elim" id="modal-fade-elim" style="display: none;">
    ...
    <div class="modal-contenedor-elim" id="modal-contenedor-elim">
        ...
        <button type="button" class="btn-eliminar" id="btn-eliminar" onclick="deleteFac()">Eliminar</button>
    </div>
