...
<script type="text/javascript">
    function showModalElim(e) {
        ...
        par.html(`¿Esta seguro que desea eliminar al usuario <b>${nom_usu}</b> con cédula: <b>${ced_usu}</b>?`)
...
<div class="modal-fade-elim" id="modal-fade-elim" style="display: none;">
    ...
    <div class="modal-contenedor-elim" id="modal-contenedor-elim">
        ...
        <button type="button" class="btn-eliminar" id="btn-eliminar" onclick="deleteUsu()">Eliminar</button>
    </div>
